...
prompt=ChatPromptTemplate.from_template(
    ...
    Please provide the most accurate respone in short based on the revelance score of the uploaded documents with the job descrption provided as input.
    Also define how many skills are matched with the {input}.
    <context>
    {context}
    <context>
    Question:{input}
